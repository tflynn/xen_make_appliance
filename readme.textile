...
p. This script will create a directory tree in ~/Dropbox/Public/xen with VM-specific subdirectories containing configuration files. Change this by changing the contents of the file 'dropbox_base_url'.
